...
import { getCustomIntegrationById, editCustomIntegration, type  CustomIntegrationPayload} from "@/services/customIntegrationService";
...
const EditCustomIntegration = () => {
    ...
    getCustomIntegrationById(id)
      .then((res) => {
        ...
        setFormData({
          ...
          max_tool_calls: 1, // Default value since not in response
          api_key: '', // Default value since not in response
          trigger_condition: '', // Default value since not in response
  ...
  const handleInputChange = (field: keyof CustomIntegrationPayload, value: any) => {
    setFormData(prev => ({
      ...prev,
      [field]: value
    }));
      ...
      <div className="p-6">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="mb-8">
            ...
            <p className="text-gray-600 mt-2">Update your custom integration settings</p>
          </div>
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <Select
                      ...
                      onValueChange={(value) => handleInputChange('http_method', value)}
                    >
                      <SelectTrigger>
                        <SelectValue />
                      </SelectTrigger>
                ...
                <div>
                  ...
                  <Textarea
                    ...
                    onChange={(e) => handleInputChange('trigger_condition', e.target.value)}
                    ...
                    {field.field_type === 'enum' && (
                      <div className="mt-4">
                        ...
                        <Input
                          ...
                          onChange={(e) => handleFieldChange(index, 'enum_values', e.target.value)}
