...
export default function AIAgentDetailPage({ agentId }: AIAgentDetailPageProps) {
  ...
  const [activateIntegration, ] = useState<any>(null);
                                    ...
                                    {integration.is_active ? (
                                      ...
                                      <Button
                                        ...
                                        onClick={async () => {
                                          ...
                                          await axios.put(`/v1/custom-integrations/${integration.id}`, { is_active: true });
                                          // Refresh list
                                          setCustomIntegrationsLoading(true);
                                          getCustomIntegrations()
                                            .then((res) => {
      ...
      <Dialog open={activateModalOpen} onOpenChange={setActivateModalOpen}>
        <DialogContent>
          ...
          <div className="space-y-4">
            ...
            <div>
              <label htmlFor="trigger_condition" className="block mb-1 text-sm">
                Trigger Condition
              </label>
              <Input
