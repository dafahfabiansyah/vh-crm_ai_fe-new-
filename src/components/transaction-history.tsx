        ...
        <TableRow>
          <TableCell colSpan={6} className="px-6 py-16 text-center">
            <div className="flex flex-col items-center space-y-4">
              ...
              <span className="text-gray-600 text-sm font-medium">Memuat transaksi...</span>
            </div>
          </TableCell>
        </TableRow>
      );
          ...
          <TableCell colSpan={6} className="px-6 py-16 text-center">
            <div className="flex flex-col items-center space-y-4">
              ...
              <div className="text-center">
                ...
                <span className="text-gray-500 text-xs mt-1">Silakan coba lagi dalam beberapa saat</span>
              </div>
            </div>
          </TableCell>
        </TableRow>
        ...
        <TableRow>
          <TableCell colSpan={6} className="px-6 py-16 text-center">
            <div className="flex flex-col items-center space-y-4">
              ...
              <div className="text-center">
                <span className="text-gray-600 text-sm font-medium block">Belum ada transaksi</span>
                <p className="text-xs text-gray-500 mt-1 max-w-sm">
                  Transaksi Anda akan muncul di sini setelah melakukan pembelian atau berlangganan.
                </p>
              </div>
            </div>
          </TableCell>
    ...
    return transactions.map((transaction) => (
      ...
      >
        ...
        <TableCell className="px-6 py-5">
          <code className="inline-flex items-center px-3 py-1.5 rounded-lg text-xs font-mono bg-gray-100 text-gray-700 border border-gray-200" 
        ...
        <TableCell className="px-6 py-5">
          <span className={`inline-flex items-center px-3 py-1.5 rounded-full text-xs font-semibold ${getTransactionTypeColor(transaction.transaction_type)}`}>
            {transaction.transaction_type === 'sub_purchase' ? 'Purchase' : 
        ...
        <TableCell className="px-6 py-5">
          <span className="text-sm font-semibold text-blue-600 hover:text-blue-800 transition-colors cursor-pointer" 
                title={transaction.id_subscription}>
            {getPlanNameById(transaction.id_subscription)}
          </span>
        </TableCell>
        <TableCell className="px-6 py-5">
          <span className={`inline-flex items-center px-3 py-1.5 rounded-full text-xs font-semibold ${getPaymentMethodColor(transaction.payment_method)}`}>
